                ...
                <div className="row">
                    <div className="mx-auto col-12 text-center">
                        <ul className="social-links mt-2">
                            <li><a href="#" className="fab fa-github largeicon"></a></li>
                            <li><a href="#" className="fab fa-linkedin largeicon"></a></li>
                            <li><a href="#" className="fas fa-project-diagram largeicon"></a></li>
                        </ul>
